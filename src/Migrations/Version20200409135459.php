 ...
 */
final class Version20200409135459 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE collaboration (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, project_id INT NOT NULL, is_admin TINYINT(1) NOT NULL, joined_at DATETIME NOT NULL, INDEX IDX_DA3AE323A76ED395 (user_id), INDEX IDX_DA3AE323166D1F9C (project_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
