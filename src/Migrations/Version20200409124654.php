 ...
 */
final class Version20200409124654 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE project (id INT AUTO_INCREMENT NOT NULL, statut_id INT NOT NULL, title VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, content LONGTEXT NOT NULL, image LONGTEXT DEFAULT NULL, nb_collaborators INT NOT NULL, nb_likes INT NOT NULL, created_at DATETIME NOT NULL, url_facebook LONGTEXT DEFAULT NULL, url_twitter LONGTEXT DEFAULT NULL, url_github LONGTEXT DEFAULT NULL, url_tipeee LONGTEXT DEFAULT NULL, is_sleeping TINYINT(1) NOT NULL, is_active TINYINT(1) NOT NULL, INDEX IDX_2FB3D0EEF6203804 (statut_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
